...
import { foxconnNitrogenRansomware } from "./foxconn-nitrogen-ransomware";
...
/**
 * Catalog order follows stable exhibit numbering (EXH-001 through EXH-048). The
 * archive page renders newest-first via `scenariosNewestFirst`.
 */
export const scenarios: Scenario[] = [
  ...
  foxconnNitrogenRansomware, // EXH-048 / 2026 May
];
