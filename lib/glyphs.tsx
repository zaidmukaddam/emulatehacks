...
const SCENARIO_GLYPH: Record<string, LucideIcon> = {
  ...
  "ai-assisted-zero-day-admin": Satellite,
  "apple-platform-cve-surge": Phone,
  "canvas-lms-compromise": BookOpen,
  ...
  "windows-kev-shell-mshtml": FileWarning,
  "windows-spoof-lure-32202": MailWarning,
  "wannacry-eternalblue": Lock,
  "yellowkey-bitlocker": KeyRound,
